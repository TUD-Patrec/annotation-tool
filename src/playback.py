...
class PlayWidget(qtw.QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        slow_back_button.triggered.connect(lambda _: self.skip_frames.emit(False, False))
        ...
        slow_forward_button.setIcon(self.style().standardIcon(qtw.QStyle.SP_ArrowForward))
        slow_forward_button.triggered.connect(lambda _: self.skip_frames.emit(True, False))
        self.slow_forward_button = slow_forward_button
                

        forward_button = qtw.QAction('forward', self)
        forward_button.setStatusTip('forward')
        forward_button.setIcon(self.style().standardIcon(qtw.QStyle.SP_MediaSkipForward))
