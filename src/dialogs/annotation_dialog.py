    ...
    def __update__(self):
        ...
        for _, group_elements in self.scheme:
            for idx, _ in enumerate(group_elements):
                ...
                if vec[effective_idx] == -1 or self.current_selection[effective_idx] == 1:
...
if __name__ == "__main__":
    ...
    dependencies = np.loadtxt('C:\\Users\\Raphael\\Desktop\\Dev\\__annotation_tool\\datasets\\Kitchen_Dataset\\dependencies.csv', delimiter=',', dtype=np.uint8)
    import json
    with open('C:\\Users\\Raphael\\Desktop\\Dev\\__annotation_tool\\datasets\\Kitchen_Dataset\\scheme.json') as f:
        scheme = json.load(f)
